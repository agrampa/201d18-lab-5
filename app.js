...
function sumArray(testArray){ //eslint-disable-line
  var addition1 = sum(testArray[0],testArray[1]);
  var addition2 = sum(addition1[0],testArray[2]);
  var message = testArray + ' was passed in as an array of numbers, and ' + addition2[0] + ' is their sum.';
  return [addition2[0], message];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  var multiply2 = multiply(multiply1[0],testArray[2]);
  var message = 'The numbers ' + testArray + ' have a product of ' + multiply2[0] + '.';
  return [multiply2[0], message];
}
